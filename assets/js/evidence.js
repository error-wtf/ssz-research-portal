(() => {
  ...
  document.addEventListener("DOMContentLoaded",async()=>{
    const response=await fetch("data/evidence-ledger.json");if(!response.ok)throw new Error(`ledger ${response.status}`);ledger=await response.json();
