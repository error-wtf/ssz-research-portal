(() => {
  ...
  const pageGuides = {
    ...
    "recursive-closure.html": {
      ...
      blocks: [
        ["One signed recurrence", "With T₀=L/c, β=v/c, σ=±1, ℓ₀=1 and t₀=0, the signed remainder obeys ℓₙ₊₁=σβℓₙ while each step adds ℓₙT₀. The sign records direction; |β|<1 is the contraction condition."],
