(() => {
  ...
  function update(){
    const lx=+$("wf-x").value,x=10**lx,m=10**(+$("wf-mass").value),u=1/(2*x),d=1/(1+u),d1=1-u,res=residual(x),radius=x*rsSun*m;
    ...
    curve("#bb8b2f",residual);curve("#3b82f6",X=>1/(2*X));
