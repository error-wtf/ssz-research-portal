(() => {
  ...
  function updateSandbox(){
    ...
    const checks=[
      ...
      ["Maximal causal/global extension",null,"separate scope; not decided by this polynomial audit"]
    ];
