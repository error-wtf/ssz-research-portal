...
claims = [
    ...
    claim("SSZ-CLAIM-XI-STRONG-001", "Canonical strong branch",
          "The canonical strong branch applies below the normalized radius 1.8.",
    ...
    claim("SSZ-CLAIM-BLEND-C2-001", "Derivative-matched C2 bridge",
          "Between normalized radii 1.8 and 2.2, a quintic Hermite bridge matches the field, its slope and its curvature at both endpoints.",
    ...
    claim("SSZ-CLAIM-XI-WEAK-001", "Canonical weak branch",
          "The canonical weak branch applies above the normalized radius 2.2 and approaches zero at infinity.",
    ...
    claim("SSZ-CLAIM-METRIC-DIAGONAL-001", "Canonical diagonal metric",
          "The public static ansatz is a diagonal, spherically symmetric metric derived from the canonical clock factor.",
    ...
    claim("SSZ-CLAIM-HORIZON-D-001", "Finite horizon time factor",
          "At the Schwarzschild scale, the locked strong branch yields finite segment-density and clock factors.",
    ...
    claim("SSZ-CLAIM-P0-CENTRE-001", "Non-regular areal centre",
          "For the current canonical diagonal continuation in areal radius, the invariant calculation yields a finite temporal coefficient and divergent Ricci/Kretschmann asymptotics; this does not rule out a different SSZ interior completion.",
    ...
    claim("SSZ-CLAIM-ORBIT-PROXY-001", "Blend-localized stationary candidates",
          "Current photon and timelike stationary candidates computed near x=2.1–2.2 are reproducible static-metric diagnostics; their physical interpretation remains conditional on the matching prescription and a complete forward model.",
    ...
    claim("SSZ-CLAIM-TESTS-BOUNDARY-001", "Software evidence boundary",
          ...
          "python3 scripts/audit_test_catalog.py", [], "9,300 catalogue records; 5,294 unique repository/test definitions; 28 test-bearing repositories; 2,280 source files; 1,296-pass historical execution subset",
    ...
    claim("SSZ-CLAIM-INTERIOR-OPEN-001", "Global interior remains open",
          "The public corpus contains interior proposals, energy-condition analyses and related tests, but no single canonical, globally matched solution has yet been certified for regularity, maximal extension, geodesic completeness and causal completeness together.",
