...
claims = [
    ...
    claim("SSZ-CLAIM-P0-CENTRE-001", "Non-regular areal centre",
          "For the present canonical diagonal continuation, the temporal coefficient remains finite while the relevant curvature invariants diverge toward the areal centre.",
